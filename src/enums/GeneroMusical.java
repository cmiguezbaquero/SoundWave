...
public enum GeneroMusical {
    ...
    HIPHOP("Hiphop","Hip hop y rap"),
    JAZZ("Jazz", "Jazz clásico y contemporáneo"),
    ELECTRONICA("Electronica", "Música electrónica y EDM"),
    REGGAETON("Reggaeton", "Reggaetón y música urbana latina"),
